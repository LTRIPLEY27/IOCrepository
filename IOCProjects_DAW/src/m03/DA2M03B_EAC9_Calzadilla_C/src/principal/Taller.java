...
public class Taller implements Component {
    ...
    private List <Component> components = new ArrayList<>(); // DECLARACION DEL ARRAY
    ...
    public List<Component> getComponents() { // métodos de acceso del ARRAYLIST
        return components;
    }

    public void setArrayListComponents(List<Component> components) {
