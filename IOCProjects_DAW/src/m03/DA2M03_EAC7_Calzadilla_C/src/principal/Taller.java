...
public class Taller{
    ...
    public static Taller addTaller() {
       ...
       // int Pmecanics, Pclients, Precanvis, Preparacions;
    ...
    public void addClient() {
        ...
        for(int i = 0; i < clients.length; i++) {
                cliente = Client.addClient(); // LLAMADA AL METODO ESTATICO DE LA CLASE CLIENTE PARA ADHERIR UN NUEVO CLIENTE.
                pClients++;
    ...
    public void addMecanic() {
        ...
        Mecanic mecanico; // VARIABLE QUE ALMACENARA EL VALOR DE MECANICO A COMPROBAR
        
            for(int i = 0; i < mecanics.length; i++) {
                    mecanico = Mecanic.addMecanic();  // ALMACENO EL VALOR DEL OBJETO MECANICO PARA VERIFICAR MEDIANTE SUS PROPIEDADES LA EXISTENCIA O NO DE OTRO ARRAY
                    pMecanics++;
    ...
    public void addReparacio() {
        ...
        Reparacio reparacion;
            ...
            for(int i = 0; i < reparacions.length; i++) {
                    reparacion = Reparacio.addReparacio();
                    pReparacions++;
                    if(selectReparacio(reparacion.getCodi()) == -1) {
                        reparacions[i] = reparacion;
                        pReparacions++;
    ...
    public void addRecanviReparacio() {    ///   REVISAR CODIGO PUES LA IMPLEMENTACION CAUSA ERROR
